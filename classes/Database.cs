...
namespace MCInventory
{
    class Database
    {
        private static string serverConfiguration = @"server=localhost;userid=root;password=;database=minecraft";
        ...
        public static ArrayList ReadBlocks()
        {
            ...
            while (rdr.Read())
            {
                records.Add(Tuple.Create(rdr.GetString(0), rdr.GrtInt32(1)));
            }
        ...
        public static void AddRecipe(Recipe input)
        {
            ...
            string sql = "INSERT INTO recipes (result, ingredient1, ingredient2, ingredient3, ingredient4, ingredient5, ingredient6, ingredient7, ingredient8, ingredient9} VALUES (@reesult,@i1,@i2,@i3,@i4,@i5,@i6,@i7,@i8,@i9)";
            using var cmd = new MySqlCommand(sql,con);
