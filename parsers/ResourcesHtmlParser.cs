...
namespace MCInventory
{
    class ResourcesHtmlParser
    {
        public static string Process(string input)
        {
            ...
            {
                HtmlNode newNode = HtmlNode.CreateNode("<li class='list-group-item'><a href='#' style='border: 0;' class='list-group-item list-group-item-action'><input class='craft-list' type=\"submit\" value=\""+ curRecipe.Result.BlockType + "\"/><img src='img/sledgeHammer_Icon.png' class='rounded float-right' style='width:50px; height:50px; margin-top:-49px; margin-right: 12%;'></li></a>");
                someNode.AppendChild(newNode);
            }
